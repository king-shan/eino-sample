...
require (
	...
	github.com/cloudwego/eino-ext/components/indexer/milvus v0.0.0-20250821122458-ae35393076b3
	github.com/cloudwego/eino-ext/components/model/ark v0.1.20
	github.com/cloudwego/eino-ext/components/retriever/milvus v0.0.0-20250821122458-ae35393076b3
	github.com/cloudwego/eino-ext/components/tool/browseruse v0.0.0-20250822083409-f8d432eea60f
